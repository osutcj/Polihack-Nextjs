export const testimonials = [
  ...
  },
  {
    ...
    image: "/assets/Testimonials/LeonardMihalcea.jpg",
    testimonial:
  ...
  },
  {
    id: 6,
    name: "Rhythm Touch",
    image: "/assets/Testimonials/RhythmTouch.jpg",
    testimonial:
      "It was our first experience at a hackathon as a team, and it made us wonder why we hadnâ€™t taken part in more of these competitions. Stress, lots of emotions, little sleep - but still, some of the most successful and special days weâ€™ve experienced during university. You shouldnâ€™t let the fear of stepping out of your comfort zone stand between you and your achievements. Itâ€™s an experience where you have only things to gain; it might be the one that opens up new perspectives, motivating you to be the best version of yourself. We know itâ€™s only 48 hours and time flies, but itâ€™s more important that the idea reflects who you are and that youâ€™re passionate about it - everything will flow smoothly from there.",
    status: "PARTICIPANT V.14",
    company: "SpiC",
  },
];
